...
import HeaderPosts from "@/components/HeaderSixRoutine";
import SideMenuHome from "@/components/SideMenuHome";
import TablePosts from "@/components/TableSixRoutine";
          ...
          <div className={styles.MainContainer}>
            <div className={styles.ListContainer} id="postos">
              <div className={styles.topMenuMobile}>
                <p className={styles.ProductNameMobile}>Rotina das 6h</p>
              </div>
              <div className={styles.ListMenu}>
                <div className={styles.ListMenu}>
                  <p className={styles.ProductName}>Rotina das 6h</p>
                  <div
