...
import { addColagemToLogin } from "../../../firebase";
...
export default function ProductPaspatur() {
  ...
  const handleButtonFinish = async (event: any) => {
    ...
    try {
      ...
      await addColagemToLogin(colagem, userId);
      ...
      <div className={styles.Container} onClick={handleOpenMenuDiv}>
        <div className={styles.BudgetContainer}>
          <div className={styles.BudgetHead}>
            <p className={styles.BudgetTitle}>Colagem</p>
            <div className={styles.BudgetHeadS}>
              ...
              >
                ...
                />
                <span className={styles.buttonText}>Cadastrar Colagem</span>
              </button>
            </div>
          </div>

          <p className={styles.Notes}>
            Informe abaixo as credencias da sua colagem
          </p>
