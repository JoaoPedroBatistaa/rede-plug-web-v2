import HeaderHome from "@/components/HeaderReportsSupervisorDates";
...
export default function Home() {
  ...
  const { post, supervisorName } = router.query;
                ...
                .map((taskGroup, index) => (
                  <div key={index} className={styles.CardMenuDate}>
                    <p className={styles.CardMenuTextDate}>
                      <a
                        href={`/reports/supervisor-tasks?post=${encodeURIComponent(
                          // @ts-ignore
                          post
                        )}&supervisorName=${encodeURIComponent(
                          // @ts-ignore
                          supervisorName
                          // @ts-ignore
