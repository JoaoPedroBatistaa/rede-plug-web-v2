...
export default function NewPost() {
  ...
  useEffect(() => {
    const postName = localStorage.getItem("userName");
  ...
  const saveNozzleClosure = async () => {
    ...
    if (!querySnapshot.empty) {
      toast.error("O encerrantes do turno 3 já foi feito hoje!");
      setIsLoading(false);
      return;
    }
    ...
    try {
      ...
      router.push("/attendants/shift-3-routine");
    } catch (error) {
  ...
  async function sendMessage(data: {
    ...
    const messageBody = `*Novo Encerrante dos Bicos Turno 03*\n\n*Data:* ${formattedDate}\n*Hora:* ${data.time}\n*Posto:* ${data.postName}\n*Responsável:* ${data.attendant}\n\n*Imagens dos Encerrantes*\n\n${imagesDetails}`;
      ...
      <div className={styles.Container}>
        <div className={styles.BudgetContainer}>
          <div className={styles.BudgetHead}>
            <p className={styles.BudgetTitle}>Encerrante dos bicos Turno 3</p>
