...
import HeaderHome from "@/components/HeaderAttendantsShift03";
  ...
  return (
    <>
      <Head>
        ...
        <title>Turno 1 - Rede Postos</title>
      </Head>
        ...
        <div className={styles.OrderContainer}>
          ...
          <div className={styles.CardsMenusContainer}>
            <div className={styles.CardsMenus}>
              ...
              <div
                onClick={() =>
                  handleNavigation("/attendants/shift-3", completedTasks.turno1)
                }
                className={`${styles.CardMenu} ${
                  completedTasks.turno1 ? styles.finished : styles.CardMenu
                }`}
              >
                <span
              ...
              <div
                onClick={() =>
                  handleNavigation(
                    "/attendants/nozzle-closure-3",
                    completedTasks.encerrantes
                  )
                }
                className={`${styles.CardMenu} ${
                  completedTasks.encerrantes ? styles.finished : styles.CardMenu
                }`}
              >
                <span
                  className={`${styles.CardMenuText} ${
