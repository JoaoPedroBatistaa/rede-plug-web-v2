...
export default function NewPost() {
  ...
  const saveNozzleClosure = async () => {
    ...
    if (!querySnapshot.empty) {
      toast.error("O encerrantes do turno 2 já foi feito hoje!");
      setIsLoading(false);
      return;
    }
  ...
  async function sendMessage(data: {
    ...
    const messageBody = `*Novo Encerrante dos Bicos Turno 02*\n\n*Data:* ${formattedDate}\n*Hora:* ${data.time}\n*Posto:* ${data.postName}\n*Responsável:* ${data.attendant}\n\n*Imagens dos Encerrantes*\n\n${imagesDetails}`;
      ...
      <div className={styles.Container}>
        <div className={styles.BudgetContainer}>
          <div className={styles.BudgetHead}>
            <p className={styles.BudgetTitle}>Encerrante dos bicos Turno 2</p>
