...
import { addFoamToLogin } from "../../../firebase";
...
export default function ProductFoam() {
  ...
  const handleButtonFinish = async (event: any) => {
    ...
    try {
      ...
      await addFoamToLogin(foam, userId);
      ...
      <div className={styles.Container} onClick={handleOpenMenuDiv}>
        <div className={styles.BudgetContainer}>
          <div className={styles.BudgetHead}>
            <p className={styles.BudgetTitle}>Foam</p>
            <div className={styles.BudgetHeadS}>
              ...
              >
                ...
                />
                <span className={styles.buttonText}>Cadastrar Foam</span>
              </button>
            </div>
          </div>

          <p className={styles.Notes}>
            Informe abaixo as credencias do seu Foam
          </p>
