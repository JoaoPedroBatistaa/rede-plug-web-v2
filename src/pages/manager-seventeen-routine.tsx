...
import TablePosts from "@/components/TableSeventeenRoutine";
          ...
          <div className={styles.MainContainer}>
            <div className={styles.ListContainer} id="postos">
              <div className={styles.topMenuMobile}>
                <p className={styles.ProductNameMobile}>Rotina das 17h</p>
              </div>
              <div className={styles.ListMenu}>
                <div className={styles.ListMenu}>
                  <p className={styles.ProductName}>Rotina das 17h</p>
                </div>
              </div>
              <div
                className={`${
