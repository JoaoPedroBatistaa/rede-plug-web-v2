...
import HeaderPosts from "@/components/HeaderSupervisorRoutine";
import SideMenuHome from "@/components/SideMenuHome";
import TablePosts from "@/components/TableSupervisorRoutine";
          ...
          <div className={styles.MainContainer}>
            <div className={styles.ListContainer} id="postos">
              ...
              <div className={styles.ListMenu}>
                <div className={styles.ListMenu}>
                  <p className={styles.ProductName}>Rotina dos supervisores</p>
                  <div
