...
import { addPaspaturToLogin } from "../../../firebase";
...
export default function ProductPaspatur() {
  ...
  const handleButtonFinish = async (event: any) => {
    ...
    try {
      ...
      await addPaspaturToLogin(paspatur, userId);
          ...
          <div className={styles.BudgetHead}>
            ...
            <div className={styles.BudgetHeadS}>
              ...
              >
                ...
                />
                <span className={styles.buttonText}>Cadastrar Paspatur</span>
              </button>
            </div>
          </div>
