...
import HeaderProducts from "@/components/HeaderSupplier";
import SearchInputListProducts from "@/components/InputSearchListSupplier";
          ...
          <div className={styles.MainContainer}>
            <div className={styles.ListContainer} id="foam">
              <div className={styles.topMenuMobile}>
                <p className={styles.ProductNameMobile}>Fornecedor</p>
              ...
              <div className={styles.ListMenu}>
                <div className={styles.ListMenu}>
                  <p className={styles.ProductName}>Fornecedor</p>
                  <div
