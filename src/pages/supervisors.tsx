...
import HeaderPosts from "@/components/HeaderSupervisor";
import SearchInputListPosts from "@/components/InputSearchListSupervisors";
import SideMenuHome from "@/components/SideMenuHome";
import TablePosts from "@/components/TableSupervisor";
          ...
          <div className={styles.MainContainer}>
            <div className={styles.ListContainer} id="postos">
              <div className={styles.topMenuMobile}>
                <p className={styles.ProductNameMobile}>Supervisores</p>
              </div>
              <div className={styles.ListMenu}>
                <div className={styles.ListMenu}>
                  <p className={styles.ProductName}>Supervisores</p>
                  <div
