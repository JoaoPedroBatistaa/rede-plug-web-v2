...
`}</style>
      ...
      <div className={styles.HeaderContainer}>
        ...
        <div className={styles.HeaderTextContainer}>
          ...
          <div className={styles.HeaderTextTitle}>Frentistas Turno 03</div>
        </div>
        <div className={styles.HeaderTextContainer}>
          <div className={styles.HeaderTextDescription}>
            <p>
              Bem-vindo à área de frentistas, onde você tem o controle total
              para gerenciar e monitorar as operações de forma eficaz.
            </p>
          </div>
        </div>
      </div>
