    ...
    <>
      ...
      <div className={styles.sideMenu}>
        ...
        <Link href='/BudgetPaspatur'>
          <div className={`${styles.MenuNavigate} ${activeRoute === '/BudgetPaspatur' ? styles.active : ''}`}>
            <img src='./check.png' className={styles.Pointer}></img>
        ...
        <Link href='BudgetCollage'>
          <div className={`${styles.MenuNavigate} ${activeRoute === '/BudgetCollage' ? styles.active : ''}`}>
            <img src='./check.png' className={styles.Pointer}></img>
        ...
        <Link href='BudgetPrint'>
          <div className={`${styles.MenuNavigate} ${activeRoute === '/BudgetPrint' ? styles.active : ''}`}>
            <img src='./check.png' className={styles.Pointer}></img>
        ...
        <Link href='BudgetShip'>
          <div className={`${styles.MenuNavigate} ${activeRoute === '/BudgetShip' ? styles.active : ''}`}>
            <img src='./check.png' className={styles.Pointer}></img>
        ...
        <Link href='BudgetSave'>
          <div className={`${styles.MenuNavigate} ${activeRoute === '/BudgetSave' ? styles.active : ''}`}>
            <img src='./check.png' className={styles.Pointer}></img>
