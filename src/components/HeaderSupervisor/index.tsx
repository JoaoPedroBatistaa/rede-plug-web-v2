...
`}</style>
      ...
      <div className={styles.HeaderContainer}>
        ...
        <div className={styles.HeaderTextContainer}>
          ...
          <div className={styles.HeaderTextTitle}>Supervisores</div>
        </div>
        <div className={styles.HeaderTextContainer}>
          <div className={styles.HeaderTextDescription}>
            <p>
              Bem-vindo à área de supervisores, onde você tem o controle total
              para gerenciar e monitorar as operações de forma eficaz. Aqui,
              você encontrará ferramentas poderosas para acompanhar o desempenho
              da equipe, analisar métricas em tempo real e tomar decisões
